...
def emnist_train(model):
    ...
    X_train = idx2numpy.convert_from_file('gzip\emnist-byclass-train-images-idx3-ubyte')
    y_train = idx2numpy.convert_from_file('gzip\emnist-byclass-train-labels-idx1-ubyte')

    X_test = idx2numpy.convert_from_file('gzip\emnist-byclass-test-images-idx3-ubyte')
    y_test = idx2numpy.convert_from_file('gzip\emnist-byclass-test-labels-idx1-ubyte')
    ...
    model.fit(X_train, x_train_cat, validation_data=(X_test, y_test_cat), batch_size=64, epochs=30)
